import {Link} from 'react-router-dom'; //This package serves one main purpose, and that is enabling us to provide routing within our application in React.

const Home = () => {
    return(
        <div className='main'>
            <div className='mainDiv'>
                <h1>Welcomt To React Fundamentals at Eleven Fifty</h1>
                <p> This app is intended to be a starter/tutorial app for your upcoming project and a learning sandbox for you in months
                    and years to come shold you continue to develop software with React. In this application, we will work through some
                    of the basic React concepts, build out small applications and then unleash you to build your own application.
                </p>
                <hr />
