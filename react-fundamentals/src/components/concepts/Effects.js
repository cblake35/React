        ...
        <div className='main'>
            <div className='mainDiv'>
                ...
                <ul>
                    ...
                    <li>Effects are use to trigger certain actions based upon changes to a component</li>
...
const SampleEffect = () => {
    ...
    const [timerRunning, setTimerRuning] = useState(false);
    ...
    useEffect(() => {
        ...
        return () => {window.clearTimeout(timer); console.log('This timer was cleaned up', Date.now()/1000)}
    });
